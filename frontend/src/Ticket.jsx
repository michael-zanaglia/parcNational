...
export default function Ticket(){
    ...
    const isHighest = useMediaQuery({query : '(min-width : 925px)'});
    ...
    return (
        <div className="ticketPage">
            ...
            <div className="ticketSection">
                <div className="cancelTicket" style={{ transform : isClicked && isHighest ? 'translateX(30vw)':'translateX(0)' }}>
                    <h1 className={!isClicked ? "leftText" : "rightText"}>Votre billet</h1>
                    <h1 className={isClicked ? "leftText" : "rightText"}>En etes-vous sur ?</h1>
                ...
                <div className="qrBanner" style={{ transform : isClicked && isHighest ? 'translateX(-70vw)':'translateX(0vw)' }}>
                    <div>
