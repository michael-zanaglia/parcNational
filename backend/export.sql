...
CREATE TABLE `campings` (
  ...
  `descritpion` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `adresse` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `price` decimal(10,2) DEFAULT NULL,
  `max_allowed` int DEFAULT NULL,
  `horraires` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `campings` VALUES (1,'Camping des cheuvreuils','ya d chevreuil','85 avenue des cheuvreils',0.00,8,'16h-17h','https://res.cloudinary.com/serdy-m-dia-inc/image/upload/w_800,c_limit/legacy_espaces//var/data/gallery/photo/86/84/45/92/16/97273.jpg\r\nhttps://www.camping-lac-savenay.fr/wp-content/uploads/2020/01/page-accueil-p-1-2.jpg\r\nhttps://cdn1.acsi.eu/6/5/9/d/659ded443f775.jpg?impolicy=gallery-detail',NULL,NULL);
...
INSERT INTO `circuits` VALUES (1,'circuit des animal','viendez decouvrir les meilleurs animals de la région','85 avenue des animals',50.00,2,'10h-24h','/photos/photo2.png\n/photos/photo3.png',1,1);
...
INSERT INTO `index_photos` VALUES (1,'https://cotedazurfrance.fr/app/uploads/cotedazur-france/2022/01/thumbs/dji-0023-2-1920x960.jpg','Index'),(2,'https://placecats.com/bella/256/256','');
...
CREATE TABLE `info_type` (
  ...
  `type` enum('annonce','actu') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `placetype` (
  ...
  `placetype` enum('montagne','riviere','foret') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `status` (
  ...
  `status` enum('ouvert','ferme','ferme def','ferme temp','travaux','complet','desactive','actif','en attente','annule') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `gender` enum('h','f') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pfp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `role` enum('user','admin','red') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id_user`)
...
-- Dump completed on 2024-10-04  8:23:42
